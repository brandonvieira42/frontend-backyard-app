...
export class PartnerDashboardService {
  ...
  public addPartnerBackyard(backyard: Backyard): Observable<string> { //return type string to allow success/err msg
    let url: string = environment.partnerApiUrl + '/addbackyard';
